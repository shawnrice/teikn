...
describe('TokenSet', () => {
  ...
  describe('composeTokenSetsAsModes', () => {
    ...
    test('multiple mode sets create multiple modes', () => {
      ...
      expect(result[0]!.modes).toEqual({ dark: '#1a1a1a', 'high-contrast': '#000000' });
    });
    ...
    test('existing modes on base tokens are preserved', () => {
      ...
      expect(result[0]!.modes).toEqual({ compact: '#003366', dark: '#66aaff' });
    });
    ...
    test('composite mode values compose and pass validate', () => {
      const lightTypography: Token = {
        name: 'heading',
        type: 'typography',
        value: { fontFamily: 'Inter', fontSize: '1rem', fontWeight: 400, lineHeight: 1.2 },
      };
      const darkTypography: Token = {
        name: 'heading',
        type: 'typography',
        value: { fontFamily: 'Inter', fontSize: '1.125rem', fontWeight: 400, lineHeight: 1.2 },
      };
