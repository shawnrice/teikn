...
describe('resolveReferences', () => {
  ...
  test('tokens with only literal modes preserve object identity through resolveReferences', () => {
    const tokens: Token[] = [
      { name: 'surface', type: 'color', value: '#ffffff', modes: { dark: '#1a1a1a' } },
    ];
  ...
  test('deeply nested composite references get resolved', () => {
    const tokens: Token[] = [
      ...
      { name: 'card', type: 'border', value: { width: '1px', style: 'solid', color: '{base}' } },
    ];
    const result = resolveReferences(tokens);
  ...
  test('resolves references in mode values', () => {
    const tokens: Token[] = [
      ...
      { name: 'surface', type: 'color', value: '#ffffff', modes: { dark: '{darkPrimary}' } },
    ];
  ...
  test('throws on circular references in modes', () => {
    const tokens: Token[] = [{ name: 'a', type: 'color', value: '#000', modes: { dark: '{a}' } }];
  ...
  test('resolves chain of refs in mode value', () => {
    const tokens: Token[] = [
      ...
      { name: 'surface', type: 'color', value: '#fff', modes: { dark: '{alias}' } },
    ];
    const result = resolveReferences(tokens);
