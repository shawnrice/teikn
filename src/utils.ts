...
const matchesString = (t1: any, t2: string) =>
  typeof t1 === 'string' && t1 === t2;

const matchesRegexp = (t1: any, t2: string) =>
  t1 instanceof RegExp && t1.test(t2);

export const matches = (t1: any, t2: string) =>
