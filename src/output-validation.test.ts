...
const spacing = scale('spacing', { xs: dp(4), sm: dp(8), md: dp(16), lg: dp(24), xl: dp(32) });
...
const borders = composite('border', {
  default: { width: new Dimension(1, 'px'), style: 'solid', color: 'rgba(0, 0, 0, 0.12)' },
});

const radius = scale('radius', { sm: dp(4), md: dp(8), full: '9999px' });

const opacities = group('opacity', { disabled: 0.38, hover: 0.08 });
